...
def _bezier_corner(c, s, flip_x=1, flip_y=1):
    ...
    for px, py, r in (
        (s * 0.42, s * 0.42, s * 0.035),
        (s * 0.18, s * 0.72, s * 0.025),
        (s * 0.68, s * 0.22, s * 0.022),
    ):
...
def draw_certificate_border(
    ...
    *,
    ...
    """Double cadre + fleurons aux angles et sur les côtés (traits allégés)."""
