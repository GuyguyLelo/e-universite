"""
Import de la maquette LMD — Semestre 7, filière RX (Réseaux et Sécurité).
Usage: python manage.py import_maquette_rx_s7 [--clear]
"""
...
# Maquette officielle Semestre 7 — RX
RX_S7_MAQUETTE = [
    {
        'ordre': 2,
        'code': 'REE2171',
        ...
        'categorie': 'A',
        'ecs': [
            {'ordre': 1, 'code': 'REE2171-EC1', 'nom': 'Routage et VLAN', 'credits': Decimal('4')},
            {'ordre': 2, 'code': 'REE2171-EC2', 'nom': 'Analyse et QoS', 'credits': Decimal('3')},
            {'ordre': 3, 'code': 'REE2171-EC3', 'nom': 'Scripting (Powershell, T-shell)', 'credits': Decimal('3')},
        ],
    },
    {
        'ordre': 6,
    ...
    },
    {
        'ordre': 7,
        'code': 'AWS2172',
        'nom': 'Administration Windows Server approfondie',
        'credits': Decimal('4'),
        'categorie': 'A',
    },
    {
    ...
    },
    {
        ...
        'categorie': 'A',
        'ecs': [
            {'ordre': 1, 'code': 'LAN2174-EC1', 'nom': 'Anglais technique', 'credits': Decimal('3')},
            {'ordre': 2, 'code': 'LAN2174-EC2', 'nom': 'Communication scientifique', 'credits': Decimal('3')},
        ],
    },
    {
        'ordre': 12,
        'code': 'RSI2175',
        'nom': 'Recherche Scientifique en Informatique',
        'credits': Decimal('3'),
        'categorie': 'B',
    },
]
...
class Command(BaseCommand):
    help = "Importe la maquette du Semestre 7 pour la filière RX."

    def add_arguments(self, parser):
        parser.add_argument(
            '--clear',
            action='store_true',
            help='Supprime les UE/EC RX du semestre 7 avant import',
        )
    ...
    def handle(self, *args, **options):
        ...
        if options['clear']:
            ...
            self.stdout.write(
                self.style.WARNING(f"Supprimé : {deleted_ue} UE, {deleted_ec} EC (RX S7).")
            )
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Maquette RX S7 importée : {ue_count} UE, {ec_count} EC, "
