...
class SuiviSaisieNotesFilterForm(forms.Form):
    ...
    def __init__(self, *args, annee=None, **kwargs):
        ...
        self.fields['session'].label_from_instance = (
            lambda obj: f'{obj.semestre.code} — Session {obj.numero} ({obj.code})'
        )
        self.fields['classe'].label_from_instance = (
            lambda obj: f'{obj.promotion.filiere.code} — {obj.promotion.code} / {obj.code}'
        )
